...
When you create an array it has a fixed size, and you can set each index equal to a certin value
...
// This same process can be done if you are removing an element, then you would move all of the elements after the deleted element over to the left by one