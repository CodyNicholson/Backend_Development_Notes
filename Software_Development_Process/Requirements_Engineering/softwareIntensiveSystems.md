...
In RE we need to pay extra close attention to the hardware and the context that our software will run in to make certain that we build the customer exactly what they want