Black-Box Testin starts from a description of the software also called a functional specification and the final result of black box testing is a set of test cases -- a set of actual inputs and corresponding outputs that we can use to exercise our code and to try and find defects
